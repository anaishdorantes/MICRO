...
void main(void) {
    ...
    while(1) {
        ...
        if (contador >= 7) {
            ...
            semaforoAmarillo = 1;
            LATAbits.LATA1 = semaforoAutosVerde;
            LATAbits.LATA2 = semaforoAmarillo;
            delay_10_seconds();
            semaforoAmarillo = 0;
            semaforoAutosRojo= 1;
            semaforoPeatonVerde = 1;
            semaforoPeatonRojo = 0;
            LATAbits.LATA2 = semaforoAmarillo;
            LATAbits.LATA3 = semaforoAutosRojo;
            LATAbits.LATA4 = semaforoPeatonVerde;
            LATAbits.LATA5 = semaforoPeatonRojo;
            delay_15_seconds();

            semaforoAutosVerde = 1;
            semaforoPeatonVerde = 0;
            semaforoPeatonRojo = 1;
            LATAbits.LATA1 = semaforoAutosVerde;
            LATAbits.LATA4 = semaforoPeatonVerde;
            LATAbits.LATA5 = semaforoPeatonRojo;
            contador = 0;
